...
# Import data set and select variables
library(foreign)
CHIS <- read.dta("/Users/jonathonthompson/Documents/data_science/chis_data_visualization/ADULT.dta")

adult <- select(CHIS, rbmi, bmi_p, racehpr2, srsex, srage_p, marit2, ab1, astcur, ab51, povll)
